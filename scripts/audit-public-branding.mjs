...
const ALLOW_LINE_RE = [
  ...
  /className=["'].*jb-/,
  /\/\*[\s\S]*JetBay|\/\/.*JetBay|Never.*JetBay|legacy JetBay|historical JetBay|Hide JetBay|strip.*JetBay|detects JetBay|no JetBay|not.*JetBay|block JetBay|JetBay i18n|JETBAY_PUBLIC_RE|assertNoJetBay/i,
  /phone\.jetbay\.local/,

...
const en: Catalog = {
  ...
  fpIncluded3: '24/7 JetBay concierge support',
  ...
  newsMetaDesc: 'Latest news from JetBay private aviation.',
  ...
  featuredVideosSubtitle: 'Highlights from JetBay events and aircraft tours.',
...
const vi: Catalog = {
  ...
  fpIncluded3: 'Hỗ trợ concierge JetBay 24/7',
  ...
  newsMetaDesc: 'Tin tức mới nhất từ JetBay.',
  ...
  featuredVideosSubtitle: 'Điểm nhấn từ sự kiện và tour máy bay JetBay.',
...
const zhCn: Catalog = {
  ...
  featuredVideos: '精选视频',
  featuredVideosSubtitle: 'JetBay 活动与飞机巡览精彩集锦。',
  watchVideo: '观看视频 →',
  videoViews: '{n} 次观看',

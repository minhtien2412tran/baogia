      ...
      <div className="jb-container">
        <div className="jb-split">
          <div>
            ...
            <h2 className="jb-section-title">JetBay SOS Global Medical Air Assistance</h2>
            ...
            <div className="jb-cta-row">
              <a href={`${p}/air-ambulance`} className="jb-btn-primary">Request JetBay SOS</a>
              <a href={`${p}/air-ambulance`} className="jb-btn-outline">Learn About JetBay SOS</a>
            </div>
          </div>

...
export const MEGA_MENU: NavGroup[] = [
  ...
  },
  {
    title: 'Services',
    links: [
      { href: '/air-ambulance', label: 'Air Ambulance / Air Ambulance', description: '24/7 medical evacuation' },
  ...
  },
  {
    title: 'Company',
    links: [
      { href: '/about-us', label: 'About JetVina', description: 'Our story & standards' },

...
/** Display titles for tag groups (large headings in Swagger UI). EN key = OpenAPI canonical. */
const TAG_LABELS: Record<'vi' | 'zh-cn', Record<string, string>> = {
  vi: {
    System: 'Hệ thống',
    Auth: 'Xác thực',
    Account: 'Tài khoản',
    Airports: 'Sân bay',
    'Quotes & Bookings': 'Báo giá & Booking',
    Bookings: 'Booking',
    ...
    Partners: 'Đối tác',
    'Content (CMS)': 'Nội dung (CMS)',
    Media: 'Media',
    Pricing: 'Định giá',
    Contracts: 'Hợp đồng',
    'Content Sync': 'Đồng bộ nội dung',
    Enquiries: 'Enquiry',
    i18n: 'Đa ngôn ngữ (i18n)',
    'API Gateway': 'API Gateway',
    'Admin Dashboard': 'Admin — Tổng quan',
    'Admin Quotes': 'Admin — Báo giá',
    'Admin Bookings': 'Admin — Booking',
    'Admin Content': 'Admin — Nội dung',
    'Admin Fixed Price': 'Admin — Giá cố định',
    'Admin Empty Legs': 'Admin — Empty Legs',
    'Admin Jet Card': 'Admin — Jet Card',
    'Admin Travel Credits': 'Admin — Travel Credits',
    'Admin Aircraft': 'Admin — Máy bay',
    'Admin Airports': 'Admin — Sân bay',
    'Admin Operators': 'Admin — Hãng',
    'Admin Email Templates': 'Admin — Template email',
    'Admin Partners': 'Admin — Đối tác',
    'Admin Users': 'Admin — Người dùng',
    'Admin Permissions': 'Admin — Quyền',
  },
  'zh-cn': {
    System: '系统',
    Auth: '鉴权',
    ...
    i18n: '多语言（i18n）',
    'API Gateway': 'API 网关',
    'Admin Dashboard': '管理端 — 总览',
    'Admin Quotes': '管理端 — 报价',
    'Admin Bookings': '管理端 — 订单',
    'Admin Content': '管理端 — 内容',
    'Admin Fixed Price': '管理端 — 固定价格',
    'Admin Empty Legs': '管理端 — 空余航段',
    'Admin Jet Card': '管理端 — Jet Card',
    'Admin Travel Credits': '管理端 — 旅行积分',
    'Admin Aircraft': '管理端 — 机队',
    'Admin Airports': '管理端 — 机场',
    'Admin Operators': '管理端 — 运营商',
    'Admin Email Templates': '管理端 — 邮件模板',
    'Admin Partners': '管理端 — 合作伙伴',
    'Admin Users': '管理端 — 用户',
    'Admin Permissions': '管理端 — 权限',
  },
};

/** Tag descriptions per language (keys = English canonical tag names). */
const TAGS: Record<SwaggerLang, Record<string, string>> = {
  ...
  vi: {
    ...
    'Admin Dashboard': 'KPI admin, báo giá/booking gần đây, audit, health hệ thống.',
    'Admin Quotes': 'Hàng đợi báo giá, đổi trạng thái, offers.',
    'Admin Bookings': 'Quản lý booking phía admin.',
    'Admin Content': 'CRUD CMS: bài viết, trang, điểm đến, video.',
    'Admin Fixed Price': 'CRUD tuyến giá cố định.',
    'Admin Empty Legs': 'CRUD empty-leg.',
    'Admin Jet Card': 'Gói và enquiry Jet Card.',
    'Admin Travel Credits': 'Gói và sổ cái travel credit.',
    'Admin Aircraft': 'Danh mục fleet / máy bay.',
    'Admin Airports': 'Master data sân bay (tọa độ, parking, base).',
    'Admin Operators': 'Hãng (operator) và user nhận mail notify.',
    'Admin Email Templates': 'Template email HTML/text (flight notify, chăm sóc KH).',
  ...
  'zh-cn': {
    ...
    'Admin Content': 'CMS 增删改查：文章、页面、目的地、视频。',
    'Admin Fixed Price': '固定价格航线 CRUD。',
    'Admin Empty Legs': '空余航段 CRUD。',
    'Admin Jet Card': 'Jet Card 套餐与咨询管理。',
    'Admin Travel Credits': '旅行积分套餐与流水。',
    'Admin Aircraft': '机队目录。',
    'Admin Airports': '机场主数据。',
    'Admin Operators': '运营商与通知用户。',
    'Admin Email Templates': '可编辑 HTML/文本邮件模板。',
...
export function getSwaggerTagLabel(lang: SwaggerLang, tagName: string): string {
  if (lang === 'en') return tagName;
  return TAG_LABELS[lang]?.[tagName] || tagName;
}

...
export const EventCharterHero = () => {
  ...
  return (
    <div className="w-full max-w-[1440px] mx-auto px-4 lg:px-8 pt-4 pb-12 font-sans">
      ...
      <div className="relative w-full rounded-[28px] overflow-hidden bg-gradient-to-r from-[#5082C5] via-[#7BB3EC] to-[#B3D9FF] min-h-[440px] md:min-h-[480px] flex flex-col justify-between p-6 md:p-10 lg:p-12 shadow-sm border border-blue-100/50 dark:border-gray-800">
        
        {/* Background Image - Coastal Santorini / Event Jet Backdrop */}
        <div className="absolute inset-0 z-0 opacity-90">
          <Image 
            src="https://images.unsplash.com/photo-1570077188670-e3a8d69ac5ff?q=80&w=1600" 
            alt="Santorini luxury event destination background" 
            fill 
            className="object-cover object-center"
            priority
            referrerPolicy="no-referrer"
          />
          <div className="absolute inset-0 bg-gradient-to-b from-blue-900/40 via-sky-900/20 to-blue-900/50"></div>
        </div>
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center pt-2 md:pt-4">
          <h1 className="text-[28px] sm:text-[36px] md:text-[42px] lg:text-[46px] font-extrabold text-white drop-shadow-md tracking-tight flex items-center justify-center gap-2">
            <span>Aircraft Charters for Events</span>

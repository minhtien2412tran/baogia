...
export const OnDemandHero = () => {
  return (
    <div id="ondemand-hero-section" className="px-4 lg:px-6 pt-4 lg:pt-6 mb-24 w-full flex flex-col items-center">
      <section id="hero-banner-inner" className="relative w-full h-[350px] lg:h-[460px] flex flex-col items-center justify-center rounded-[24px] overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-4 w-full max-w-5xl -mt-16">
          <h1 className="text-4xl md:text-5xl lg:text-[56px] font-bold tracking-tight leading-[1.1] mb-5">
            Private Jets for Every Need<span className="text-[#40DACD]">.</span>
          </h1>
      ...
      <div id="search-form-container" className="relative z-20 w-full max-w-[1440px] -mt-12 lg:-mt-20 bg-white dark:bg-[#152033] rounded-[24px] shadow-[0_8px_30px_rgb(0,0,0,0.08)] p-6 lg:p-8 text-gray-900 dark:text-white border border-gray-100 dark:border-gray-800">
        ...
        <div className="flex flex-col lg:flex-row items-end gap-3 lg:gap-4 mb-6 relative w-full">
          ...
          <div className="flex-[1.2] w-full">
            <span className="text-[13px] text-gray-800 dark:text-gray-300 font-bold block mb-2">From</span>
            <div className="flex items-center gap-3 border border-gray-200 dark:border-gray-700 rounded-xl p-3.5 bg-[#F8FAFC] dark:bg-[#0E1726] hover:border-gray-300 dark:hover:border-gray-600 transition-colors">
              <PlaneTakeoff className="text-gray-400 dark:text-gray-500" size={18} strokeWidth={2.5} />
              <input type="text" placeholder="From" className="outline-none text-[14px] text-gray-900 dark:text-white bg-transparent w-full placeholder:text-gray-400 dark:placeholder:text-gray-500 font-bold" />
            </div>
          </div>
          ...
          {/* To */}
          <div className="flex-[1.2] w-full">
            <span className="text-[13px] text-gray-800 dark:text-gray-300 font-bold block mb-2">To</span>
            <div className="flex items-center gap-3 border border-gray-200 dark:border-gray-700 rounded-xl p-3.5 bg-[#F8FAFC] dark:bg-[#0E1726] hover:border-gray-300 dark:hover:border-gray-600 transition-colors">
              <PlaneLanding className="text-gray-400 dark:text-gray-500" size={18} strokeWidth={2.5} />
              <input type="text" placeholder="To" className="outline-none text-[14px] text-gray-900 dark:text-white bg-transparent w-full placeholder:text-gray-400 dark:placeholder:text-gray-500 font-bold" />
            </div>
          </div>
          
          {/* Departure */}
          <div className="flex-1 w-full">
            <span className="text-[13px] text-gray-800 dark:text-gray-300 font-bold block mb-2">Departure (Local)</span>
            <div className="flex items-center gap-3 border border-gray-200 dark:border-gray-700 rounded-xl p-3.5 bg-[#F8FAFC] dark:bg-[#0E1726] hover:border-gray-300 dark:hover:border-gray-600 transition-colors cursor-pointer">
              <Calendar className="text-gray-400 dark:text-gray-500" size={18} strokeWidth={2.5} />
              <div className="text-[14px] text-gray-900 dark:text-white font-bold whitespace-nowrap">
                13 / Jul / 2026
              </div>
            </div>
          </div>
          ...
          {/* Passengers */}
          <div className="flex-1 w-full">
            <span className="text-[13px] text-gray-800 dark:text-gray-300 font-bold block mb-2">Passengers</span>
            <div className="flex items-center justify-between w-full border border-gray-200 dark:border-gray-700 rounded-xl p-3.5 bg-[#F8FAFC] dark:bg-[#0E1726]">
              ...
              <span className="text-[14px] font-bold text-gray-900 dark:text-white">2</span>

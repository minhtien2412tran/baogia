...
| **R4** | CMS/media/settings/audit · wire or delete orphan content_* keys                                     | Content workflow separation (view/review/publish/rollback/approve production)  | **Partial** — CMS + media `PermissionGuard` DEPLOYED 24/07 (`133626`); settings/audit/orphan keys còn |

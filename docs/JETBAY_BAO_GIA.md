...
| **Dự án** | Hệ thống đặt thuê máy bay tư nhân — **JETBAY Platform** (clean-room, tham chiếu jet-bay.com) |
...
| Tên dự án | Nền tảng Private Jet Charter JETBAY |
...
|-----|-----|----------|----------------|------|---------------|-----------------|
| A1 | `FE-CORE` | **Public Web Next.js 16** | 29 route · 6 locale · Home API-driven · Quote widget · SEO/OG JETBAY · ~164 asset local | 4 | **32.000.000** | 🟡 ~70% |
...
| Admin | Next.js 16 · @JETBAY/ui | Dashboard nội bộ |
...
├── packages/ui/       → @JETBAY/ui shared components
├── scripts/           → download-jetbay-assets, rebrand-jetbay
...
7. Asset JETBAY (logo, favicon, OG) + thư viện ảnh marketing  
...
*Báo giá tương tác: [https://m-tien.com/jet-bay/](https://m-tien.com/jet-bay/) · Tài liệu kỹ thuật: `docs/JETBAY_DANH_GIA_KY_THUAT.md` · Phụ lục AI gán nhãn: `docs/PHU_LUC_AI_GAN_NHAN_TAO_GROUNDINGDINO.md`*
